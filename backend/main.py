...
async def upload_se_file(file: UploadFile = File(...)):
    ...
    try:
        ...
        # Parse INK2 data (tax calculations) - pass RR data and BR data for variable references
        ink2_data = parser.parse_ink2_data(current_accounts, company_info.get('fiscal_year'), rr_data, br_data)
